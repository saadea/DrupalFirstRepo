...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_learning_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_learning_dd.inc';
}
// </DDSETTINGS>
$settings['install_profile'] = 'standard';
 ...
 $settings["trusted_host_patterns"]=array('^localhost$', '^.*\.dd$');